...
class SettingNode: SKNode {
    ...
    private func setupMenu() {
        ...
        let modal = SKSpriteNode(imageNamed: "SettingBackground")
        modal.zPosition = 100
        modal.name = "settingBackground"
        modal.position = CGPoint.zero
        modal.setScale(0.18)
        addChild(modal)
        
        // Resume Button
        let resumeButton = SKSpriteNode(imageNamed: "CloseButton")
        resumeButton.name = "closeButton"
